<div class="wrapper-content "id="ok">
	<div class="row">
		<!-- Headings-->
		<div class="col-sm-3">
			<div class="ibox float-e-margins">
				<div>
					<div class="profile-img-box"> 
						<div class="profile-avetar pr-0 w-100 text-center"> 
							<img class="profile-avetar-img" src="../assets/images/uploads/{USU_IMAGEN}" alt="Teddy Wilson" width="128" height="128"> 
						</div>
						<a href="#" class="pro-like"> 
						<i class="fa fa-heart-o" aria-hidden="true"></i> 398</a> 
					</div>
					<div class="widgets-container">
						<h4><strong>{USU_NOMBRES} {USU_APELLIDOS}</strong></h4>
						<p><i class="fa fa-map-marker"></i> 796 Silver Harbour, TX 79273, US</p>
						<h5> Sobre mí</h5>
						...
						<div class="user-button">
							<div class="row">
								<div class="col-md-6">
									<button class="btn aqua  btn-sm btn-block" type="button"><i class="fa fa-envelope"></i> Send Message</button>
								</div>
								<div class="col-md-6">
					...
					<div class="widgets-container">
						...
						<p class="small"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't
						anything embarrassing </p>
						<div class="user-friends"> 
							<a href=""><img src="../assets/images/teem/placeholders.jpg" class="img-circle" alt="image"></a> 
							<a href=""><img src="../assets/images/teem/placeholders.jpg" class="img-circle" alt="image"></a> 
							<a href=""><img src="../assets/images/teem/placeholders.jpg" class="img-circle" alt="image"></a> 
							<a href=""><img src="../assets/images/teem/placeholders.jpg" class="img-circle" alt="image"></a> 
							<a href=""><img src="../assets/images/teem/placeholders.jpg" class="img-circle" alt="image"></a> 
			...
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					...
					<div class="ibox-tools"> 
						<a data-target="#demo1"  data-toggle="collapse" class="collapse-link"> 
							...
							<div class="feed-activity-list">
								<div class="feed-element">
									<a href="#" class="pull-left">
										<img alt="image" class="img-circle" src="../assets/images/teem/placeholders.jpg"> 
									</a>
									<div class="media-body ">
										...
										<div class="actions"> 
											...
											</a> <a class="btn btn-xs btn-danger"><i class="fa fa-heart"></i> Love</a> </div>
									</div>
								</div>
								<div class="feed-element">
									<a href="#" class="pull-left">
									...
									<div class="media-body ">
										<small class="pull-right">5m ago</small> <strong>Ol
										ivia Wenscombe</strong> posted a new blog. <br>
								...
								<div class="feed-element">
									...
									<div class="media-body ">
										<small class="pull-right">2h ago</small> <strong>Ro
										bert Angier</strong> posted message on <strong>Olivia Wenscombe</strong> site. <br>
										...
										<a class="btn btn-xs aqua"><i class="fa fa-pencil"></i> Message</a> </div>
									</div>
								</div>
								<div class="feed-element">
									<a href="#" class="pull-left">
									...
									<div class="media-body ">
										<small class="pull-right">2h ago</small> <strong>Ar
										iadne</strong> add 1 photo on <strong>Olivia Wenscombe</strong>. <br>
										<small class="text-muted">2 days ago at 8:30am</small>
										<div class="photos"> <img alt="image" class="feed-photo" src="../assets/images/demo_files/placeholders.jpg"> </div>
									</div>
								</div>
								<div class="feed-element">
									<a href="#" class="pull-left">
									...
									<div class="media-body ">
										...
										<strong> Alex Smith </strong> started following <strong>Olivia Wenscombe</strong>. <br>
								...
								<div class="feed-element">
									...
									<div class="media-body ">
										<small class="pull-right">2h ago</small> <strong>Su
										san Wenscombe </strong> posted message on <strong>Olivia Wenscombe</strong> site. <br>
								...
								<div class="feed-element">
									...
									<div class="media-body ">
										<small class="pull-right">23h ago</small> <strong>O
										livia Wenscombe</strong> love <strong>Sophie </strong>. <br>
								...
								<div class="feed-element">
									...
									<div class="media-body ">
										<small class="pull-right">46h ago</small> <strong>M
										ike Loreipsum</strong> started following <strong>Olivia Wenscombe</strong>. <br>
			...
			<div class="ibox">
				<div class="widgets-container">
					<div class="feed-element">
						...
						<div class="media-bod
						y "> <strong>Olivia Wenscombe </strong>send Friend R
							equests to you . <br>
							<small class="text-muted">Today 9:00 pm - 11.06.2016</small>
